import type { NsGraphCmd, IToolbarGroupOptions } from '@antv/xflow'
import { IconStore, MODELS, XFlowGraphCommands,  createToolbarConfig} from '@antv/xflow'
import {
  ZoomInOutlined,
  ZoomOutOutlined,
  OneToOneOutlined,
...
export const useScaleToolConfig = createToolbarConfig(config => {
